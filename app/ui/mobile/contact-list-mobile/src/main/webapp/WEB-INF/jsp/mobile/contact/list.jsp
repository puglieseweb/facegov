    ...
    <div class="content" data-role="content">
        <ul data-role="listview" data-inset="true" data-theme="d" data-divider-theme="d">
            ...
            <c:forEach var="contact" items="${contactList}" varStatus="status">
                ...
                <li><a href="detail.do?id=${status.index}" data-transition="slide"><c:out
                        value="${contact.firstName} ${contact.lastName}"></c:out></a></li>
            </c:forEach>
        </ul>
    </div>

    <footer data-role="footer">
        <a href="#sitePreferenceSelectionPage" data-rel="dialog" data-role="button" data-icon="gear">Edit Site
            Preference</a>
    </footer>
