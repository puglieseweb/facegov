 ...
 */
package com.facegov.lib.persistence.dao.hibernate;
...
import com.facegov.lib.persistence.dao.Dao;
...
public abstract class AbstractHbnDao<T extends Object> implements Dao<T> {
	...
	/* (non-Javadoc)
	 * @see com.facegov.lib.persistence.dao.Dao#create(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.facegov.lib.persistence.dao.Dao#get(java.io.Serializable)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see com.facegov.lib.persistence.dao.Dao#load(java.io.Serializable)
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see com.facegov.lib.persistence.dao.Dao#update(java.lang.Object)
	 */
	@Override
	public void update(T t) { getSession().update(t); }
	
	/* (non-Javadoc)
	 * @see com.facegov.lib.persistence.dao.Dao#delete(java.lang.Object)
	 */
	@Override
	public void delete(T t) { getSession().delete(t); }
	
	/* (non-Javadoc)
	 * @see com.facegov.lib.persistence.dao.Dao#deleteById(java.io.Serializable)
	 */
	@Override
	public void deleteById(Serializable id) { delete(load(id)); }
	
	/* (non-Javadoc)
	 * @see com.facegov.lib.persistence.dao.Dao#deleteAll()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.facegov.lib.persistence.dao.Dao#count()
	 */
	@Override
	public long count() {
	...
	/* (non-Javadoc)
	 * @see com.facegov.lib.persistence.dao.Dao#exists(java.io.Serializable)
	 */
	@Override
